...
namespace SpaceBHGame.Gameplay
{
    public class Bullet
    {
        ...
        public Vector2 Direction; // Where the bullet is headed at this moment

        //Constructor
        public Bullet(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
        ...
        //public void Initialize(Animation animation, Texture2D texture, float speed, Vector2 position, Vector2 direction)
        public void Initialize(Vector2 position, float speed, Texture2D texture, Vector2 direction)
        {
            _is_active = true;
            _texture = texture;
            _move_speed = speed;
    ...
    public class PlayerBullet : Bullet
    {
        ...
        {
            _position.Y -= (Direction.Y * _move_speed);
            _position.X += (Direction.X * _move_speed);
        }
    }
    ...
    {
        // Constructor
        public Ball(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
    ...
    class BallSpread : PlayerBullet
    {
        // Constructor
        public BallSpread(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
    ...
    class Triangle : EnemyBullet
    {

        // Enemy diamond bullet, three level increasing, goes in the direction of the player
        public Triangle(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
    ...
    class Diamond : EnemyBullet
    {
        ...
        // Enemy diamond bullet, three level increasing, goes in the direction of the player
        public Diamond(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
    ...
    class BigBall : EnemyBullet
    {
        ...
        // Constructor
        public BigBall(Texture2D texture, float speed, Vector2 position, Vector2 aim_direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
    ...
    class RingOfDeath : EnemyBullet
    {
        public RingOfDeath(Texture2D texture, float speed, Vector2 position, Vector2 direction)
        {
            _texture = texture;
            _move_speed = speed;
            _position = position;
        ...
        public override void Update(GameTime gameTime)
        {
            _position.Y -= (Direction.Y * _move_speed + 20);
            _position.X -= (Direction.X * _move_speed);
        }
...
namespace SpaceBHGame.Player
{
    internal class Gameplay
    {
        ...
        protected void AddBullet()
        {
            ...
            bullet.Initialize(bulletAnimation, bulletPosition, 25, true);
            bullets.Add(bullet);
        }
        ...
        protected void AddEnemyBullet(Enemy enemy)
        {
            ...
            enemyBullet.Initialize(enemyBulletAnimation, enemyBulletPosition, 25, false);
